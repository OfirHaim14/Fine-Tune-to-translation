...
if __name__ == '__main__':
    ...
    print(parsed_german_paragraphs_val[3])
    ...
    val_dataset = paragraphs_to_dataset(parsed_german_paragraphs_val[:100], english_paragraphs_val[:100])
    val_dataset_unparsed = paragraphs_to_dataset(german_paragraphs_val[:100], english_paragraphs_val[:100])
    ...
    # Define the model
    model = AutoModelForSeq2SeqLM.from_pretrained(SAVED_PATH)
    '''
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        num_train_epochs=4,  # default 3.0
