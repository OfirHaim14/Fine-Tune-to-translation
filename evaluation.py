...
def read_file(file_path):
    """
    The function reads the file and save the paragraphs in it.
    @param file_path: The path to the paragraphs file.
    @return: List of english and the matching german paragraphs.
    """
    file_en, file_de = [], []
...
def compute_metrics(tagged_en, true_en):
    """
    The function calculate the BLEU score between the real translation and the model's translation.
    @param tagged_en: The model's translation.
    @param true_en: The real translation.
...
def calculate_score(file_path1, file_path2):
    """
    The function calculates the BLEU score using the previous function, between the model's translation that
    was written into a file and the real translation that is in a different file.
    @param file_path1: First file.
    @param file_path2: Second file.
    """
...
def write_to_file(dataset, path):
    """
    Write the model's translation to the given file.
    @param dataset: the dataset to be translated.
...
def evaluate_model(model, parsed_val_dataset):
    ...
    @param parsed_val_dataset: The validation data set.
    @return: The result.
    """
    tagged_en, true_en = [], []
