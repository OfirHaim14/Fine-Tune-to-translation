...
comp_raw_paragraphs_copy = comp_raw_paragraphs.copy()
parsed_german_paragraphs_comp = add_roots_and_modifiers_unlabeled(comp_raw_paragraphs_copy, comp_roots, comp_modifiers)
...
val_raw_paragraphs_copy = val_raw_paragraphs.copy()
parsed_german_paragraphs_val = add_roots_and_modifiers_unlabeled(val_raw_paragraphs_copy, val_roots, val_modifiers)

# Create datasets of the files
val_dataset = paragraphs_to_dataset(parsed_german_paragraphs_val, english_paragraphs_val)
val_dataset_unlabeled = paragraphs_to_dataset_unlabeled(parsed_german_paragraphs_val)
comp_dataset_unlabeled = paragraphs_to_dataset_unlabeled(parsed_german_paragraphs_comp)
val_dataset_unparsed = paragraphs_to_dataset_unlabeled(val_raw_paragraphs)
comp_dataset_unparsed = paragraphs_to_dataset_unlabeled(comp_raw_paragraphs)
